use super::{super::store::*, event_handler::*, id::*, instance::*, kind::*, metadata::*, prefix::*, property::*};
...
impl Template {
    ...
    /// Instantiate.
    pub fn instantiate<StoreT>(&self, kind: Kind, prefix: &Prefix, store: &StoreT) -> Result<Instance, StoreError>
    where
        StoreT: Store,
    {
        let mut id = ID::new(kind, prefix.clone());
