...
impl Property {
    ...
    pub fn new(
        ...
        Self { metadata: Default::default(), class_ids: Default::default(), variant, updater, validator, read_only }
    }
        ...
        ErrorRecipientT: kutil::std::error::ErrorRecipient<super::super::FloriaError>,
    {
        ...
        if let Some(updater) = &self.updater {
            self.variant = unwrap_or_give!(updater.evaluate(site, library, plugin_name).map(Some), errors, None);
        }

        self.validate(site, library, plugin_name, errors)
    }
        ...
        ErrorRecipientT: kutil::std::error::ErrorRecipient<super::super::FloriaError>,
    {
        ...
        if let Some(validator) = &self.validator {
            unwrap_or_give!(validator.evaluate::<_, WithoutAnnotations>(site, library, plugin_name).map(Some), errors);
        }
    ...
    StoreT: Store,
{
        ...
        WriteT: io::Write,
    {
        ...
        utils::depict_field("value", false, writer, context, |writer, context| -> io::Result<()> {
        ...
        utils::depict_field("updater", false, writer, context, |writer, context| -> io::Result<()> {
        ...
        utils::depict_field("validator", false, writer, context, |writer, context| -> io::Result<()> {
        ...
        utils::depict_field("read_only", true, writer, context, |writer, context| -> io::Result<()> {
            context.separate(writer)?;
