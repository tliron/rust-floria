use super::{super::store::*, depict::*, id::*, kind::*, node_selector::*, prefix::*, relationship::*, template::*};
...
impl RelationshipTemplate {
    ...
    where
        StoreT: Store,
    {
        let mut id = ID::new(Kind::RelationshipTemplate, prefix);
    ...
    pub fn new_for(
        ...
        Self::new_with(
            ID::new_for(Kind::RelationshipTemplate, prefix, id),
        ...
        StoreT: Store,
    {
        let relationship = Relationship {
            instance: self.template.instantiate(Kind::Relationship, prefix, store)?,
            source_node_id,
            target_node_id,
        };
