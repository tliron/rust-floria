use super::{super::store::*, id::*, kind::*, metadata::*, prefix::*, property::*};
...
impl Instance {
    /// Constructor.
    pub fn new_for(kind: Kind, prefix: Prefix, id: ByteString, origin_template_id: Option<ID>) -> Self {
        Self::new_with(ID::new_for(kind, prefix, id), origin_template_id)
    }
