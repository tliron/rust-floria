    ...
    StoreT: Store<AnnotatedT>,
{
    ...
    pub fn to_guest_any(&mut self, value: normal::Variant<AnnotatedT>) -> Result<dispatch::Any, PluginError> {
        match value {
    ...
    pub fn from_guest_value(&mut self, value: dispatch::Any) -> Result<normal::Variant<AnnotatedT>, PluginError>
    where
        AnnotatedT: Default,
    {
        match value {
