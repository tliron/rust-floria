...
impl Relationship {
        ...
        StoreT: StoreClient,
    {
        ...
        if !embedded {
            map.insert("source_node_id".into(), self.source_node_id.id.clone().into());
        }

        map.insert("target_node_id".into(), self.target_node_id.id.clone().into());
    ...
    StoreT: StoreClient,
{
        ...
        WriteT: io::Write,
    {
        ...
        write_debug_types(&self.relationship.instance.type_ids, self.store, writer, context)?;
        write_debug_properties("properties", &self.relationship.instance.properties, false, writer, context)?;
