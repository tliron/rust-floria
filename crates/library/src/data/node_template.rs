...
impl NodeTemplate {
    ...
    ) -> Result<super::Node, super::super::ImperativeError>
    where
        StoreT: StoreClient,
        ErrorRecipientT: kutil_std::error::ErrorRecipient<super::super::ImperativeError>,
    {
        ...
        match library.environment.store.get_node(&node_id)? {
            Some(mut node) => {
            ...
            None => Err(super::super::StoreError::ID(node_id.to_string()).into()),
        }
    }
    ...
    pub fn instantiate_nodes<StoreT, ErrorRecipientT>(
        ...
        plugin_name: &str,
        errors: &mut ErrorRecipientT,
    ) -> Result<ID, super::super::ImperativeError>
    where
        StoreT: StoreClient,
        ErrorRecipientT: kutil_std::error::ErrorRecipient<super::super::ImperativeError>,
    {
