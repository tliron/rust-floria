...
impl Entity {
    ...
    pub fn is_in_class(&self, class_id: &Id) -> Result<bool, String> {
        match self.any.get(&"class_ids".into()) {
            Some(class_ids) => match class_ids {
                Any::NestedList(class_ids) => {
    ...
    pub fn get_containing_vertex_id(&self) -> Result<Option<Id>, String> {
        match &self.id.kind {
            Kind::Vertex => match self.any.get(&"containing_vertex_id".into()) {
    ...
    pub fn get_origin_template_id(&self) -> Result<Option<Id>, String> {
        match &self.id.kind {
            Kind::Vertex => match self.any.get(&"origin_template_id".into()) {
            ...
            Kind::Edge => match self.any.get(&"origin_template_id".into()) {
                Some(origin_template_id) => match origin_template_id {
    ...
    pub fn get_contained_vertex_ids(&self) -> Result<Vec<Id>, String> {
        match &self.id.kind {
            Kind::Vertex => match self.any.get(&"contained_vertex_ids".into()) {
                Some(contained_vertex_ids) => match contained_vertex_ids {
                    Any::NestedList(contained_vertex_ids) => {
    ...
    pub fn get_outgoing_edge_ids(&self) -> Result<Vec<Id>, String> {
        match &self.id.kind {
            Kind::Vertex => match self.any.get(&"outgoing_edge_ids".into()) {
                Some(outgoing_edge_ids) => match outgoing_edge_ids {
                    Any::NestedList(outgoing_edge_id) => {
    ...
    pub fn get_incoming_edge_ids(&self) -> Result<Vec<Id>, String> {
        match &self.id.kind {
            Kind::Vertex => match self.any.get(&"incoming_edge_ids".into()) {
                Some(incoming_edge_ids) => match incoming_edge_ids {
                    Any::NestedList(incoming_edge_id) => {
    ...
    pub fn get_source_vertex_id(&self) -> Result<Id, String> {
        match &self.id.kind {
            Kind::Edge => match self.any.get(&"source_vertex_id".into()) {
    ...
    pub fn get_target_vertex_id(&self) -> Result<Id, String> {
        match &self.id.kind {
            Kind::Edge => match self.any.get(&"target_vertex_id".into()) {
...
impl<'own> Property<'own> {
    ...
    pub fn value(&self) -> Option<&Any> {
        self.any.get(&"value".into())
    }

    /// Metadata.
    pub fn metadata(&self) -> Result<Option<&BTreeMap<Any, Any>>, String> {
        match self.any.get(&"metadata".into()) {
            Some(metadata) => match metadata {
                Any::NestedMap(metadata) => Ok(Some(&metadata.to_map().inner)),
