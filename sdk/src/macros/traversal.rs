...
/// Traverse a value by calling [Any::get](super::super::data::Any::get) recursively.
///
/// The first argument is the starting [any::Any](super::super::data::Any). The following arguments
...
///
/// The keys are either [Any](super::super::data::Any) or anything that implements
/// [Into]<[Any](super::super::data::Any)>, which includes all the supported primitive types.
#[macro_export]
...
/// Traverse a value by calling [Any::get_mut](super::super::data::Any::get_mut) recursively.
///
/// The first argument is the starting [Any](super::super::data::Any). The following arguments
/// are a sequence of keys, which will be tried one at a time. Any non-collection or
/// missing key will cause the macro to stop and return [None].
///
/// The keys are either [Any](super::super::data::Any) or anything that implements
