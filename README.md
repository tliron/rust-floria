...
All the above entities live in nested prefixes that can be used to organize them hierarchically. Prefixes can be used for selection and permissions.

Another way to organize entities is to assign them to any number of "groups". Groups are themselves entities, stored in prefixes. They can be used to apply policies and type information for both data and behavior.
